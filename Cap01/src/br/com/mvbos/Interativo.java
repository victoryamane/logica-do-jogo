...
public class Interativo extends JFrame {
    ...
    private final int FPS = 1000 / 20; // 50fps
            ...
            public void keyPressed(KeyEvent e) {
                ...
                switch (tecla) {
                    case KeyEvent.VK_ESCAPE: // tecla ESC
                        ...
                        break;
                    case KeyEvent.VK_UP: // tecla seta para cima
                        py--;
                        break;
                    case KeyEvent.VK_DOWN: // tecla seta para baixo
                        py++;
                        break;
                    case KeyEvent.VK_LEFT: // tecla seta para esquerda
                        px--;
                        break;
                    case KeyEvent.VK_RIGHT: // tecla seta para direita
                        px++;
                        break;
                }
            }
